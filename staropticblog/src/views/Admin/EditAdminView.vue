                ...
                <v-row align="center" justify="center">
                  <v-col cols="12" md="10">
                    <v-card-text class="mt-12">
                      <h4 class="text-center">Ažuriranje korisnika - {{user.firstName}} {{user.lastName}}</h4>
                     ...
                     <v-text-field
                      ...
                      <v-text-field
                        ...
                        <p class="text-center fw-bold">Uloga:</p>
                        <div class="d-flex align-items-center justify-content-around pb-5">
                          ...
                          <v-radio
                            ...
                            :label="role.name"
                            :value="role.id"
                            :off-icon="RoleId==role.id ? '$radioOn' : '$radioOff'"
                            v-on:change="setRole(role.id)"
                          ></v-radio>
                      ...
                      <v-text-field
                       ...
                       <!-- slika-->
                        ...
                        <div class="text-center">
                            ...
                            <v-btn link rounded class="text-white" color="blue darken-1" to="/admin/users">Svi korisnici</v-btn>                              
                        </div>
