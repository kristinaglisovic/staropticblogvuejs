                ...
                <v-row align="center" justify="center">
                  <v-col cols="12" md="10" sm="12">
                    <v-card-text class="mt-12">
                      <h1 class="text-center">Edit posta - {{this.$route.params.id}}</h1>
                     ...
                     <v-text-field
                        ...
                        <div class="pt-5">
                          ...
                          <div class="text-center mt-3"> 
                           <v-btn type="submit" class="my-2 m-1" rounded color="amber darken-1" :disabled="!isFormValid">EDITUJ</v-btn>
                         
                           <v-btn to="/admin/posts"  class="my-2" rounded color="green text-white m-1 darken-1">POSTOVI</v-btn>
                           <v-btn :to="{name:'post',params:{id:this.$route.params.id}}" class="my-2" rounded color="blue text-white m-1 darken-1"><i class='fa-solid fa-eye'></i></v-btn>
                       </div>
                      </v-form>
                    </v-card-text>
 ...
 methods: {
      ...
      loadPost(){
        ...
        axios.get(`posts/${this.$route.params.id}`)
             .then(response => {
                ...
                this.heading1=response.data.heading1;
                this.heading2=response.data.heading2;
                this.text1=response.data.text1;
                this.text2=response.data.text2;
                this.selected.categories=response.data.categoriesIds;
                this.selected.tags=response.data.tagsIds;
                this.selected.images=response.data.imagesIds;
                if(this.feedback2){
     ...
     handleSubmit(){
      axios.patch('posts/edit',{
                    ...
                    .then(()=>{
                        this.feedback2='Uspešno ste editovali post.'
                        this.feedback=''
                        if(this.feedback2){
                            setTimeout(this.resetF, 1400)
                         }
