                  ...
                  <v-row align="center" justify="center">
                    <v-col cols="12" md="10">
                      <v-card-text class="mt-12">
                        <h1 class="text-center display-2 siva">Registracija</h1>
                        <div class="text-center mt-4">
                         <i class="fa-solid h2 fw-bold fa-user-plus"></i>
                       </div>
                      
                        <h4 class="text-center mt-4 siva">Napravite nalog za Star Optik Blog</h4>
                         ...
                         <!-- slika-->
                          <template>
                           ...
                           <div class="text-center mt-3"> 
                             <v-btn type="submit" rounded color="amber darken-1" :disabled="$v.$invalid">Registrujte se</v-btn>
                           
                         </div>
                        </v-form>
                      </v-card-text>
                         <p class="text-center mt-4 text-muted">Imate nalog?<i class="fa-solid ml-2 fa-hand-point-right fw-bold text-muted"></i><v-btn text small class="text-primary ml-1" to="/login">Prijavite se</v-btn></p>                              
